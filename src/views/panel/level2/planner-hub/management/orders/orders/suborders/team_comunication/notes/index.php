...
$router->post(function () {
    ...
    foreach ($notes as $id_service => $text) {
        ...
        $data = [
            ...
            'install_time' => !empty($installTimes[$id_service]) ? $installTimes[$id_service] : null,
            'execution_time' => !empty($executionTimes[$id_service]) ? $executionTimes[$id_service] : null,
            'breakdown_time' => !empty($breakdownTimes[$id_service]) ? $breakdownTimes[$id_service] : null,
            'start_time' => !empty($startTimes[$id_service]) ? $startTimes[$id_service] : null
        ];
