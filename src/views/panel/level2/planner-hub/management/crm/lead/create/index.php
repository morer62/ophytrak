...
$router->post(function () {
    ...
    if ($existing) {
        MessageUtil::setMessage(TranslationService::trans('planner_hub.lead_email_exists'));
        LocationUtils::reload();
    }
    ...
    MessageUtil::setMessage(TranslationService::trans('planner_hub.lead_created_successfully'));
