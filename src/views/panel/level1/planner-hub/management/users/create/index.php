...
function sendTemporaryPasswordEmail(string $email, string $name, string $temporaryPassword, string $userType, ?int $ownerId = null): bool
{
    try {
        ...
        $subject = "Welcome to Ophyra - Your Temporary Password";
        ...
        <body>
            <div class='container'>
                ...
                <div class='content'>
                    ...
                    <p>Best regards,<br><strong>The Ophyra Team</strong></p>
                </div>
                <div class='footer'>
...
$router->post(function () {
    ...
    if ($inactiveUser) {
        if ((int)$inactiveUser->level === 4) {
            ...
            sendTemporaryPasswordEmail($_POST["email"], $_POST["name"], $temporaryPassword, $_POST["level"], $currentOwnerId);
