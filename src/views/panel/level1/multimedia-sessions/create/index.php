...
$router->post(function () {
    ...
    if ($sessionRepo->add($data)) {
        ...
        TranslationService::detectLocale();
        MessageUtil::setMessage(TranslationService::trans('planner_hub.multimedia_session_created_successfully'));
        LocationUtils::redirectInternal("panel/multimedia-sessions");
    } else {
        TranslationService::detectLocale();
        MessageUtil::setMessage(TranslationService::trans('planner_hub.error_creating_multimedia_session'));
        LocationUtils::reload();
    }
});
