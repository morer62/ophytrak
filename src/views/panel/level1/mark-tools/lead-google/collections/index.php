...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST["name"])) {
    ...
    if ($name !== "") {
        ...
        MessageUtil::setMessage(TranslationService::trans('planner_hub.collection_created_successfully'));
    }
...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST["delete_collection"])) {
    ...
    TranslationService::detectLocale();
    MessageUtil::setMessage(TranslationService::trans('planner_hub.collection_deleted'));
    LocationUtils::reload();
