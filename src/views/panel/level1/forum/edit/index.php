...
$router->get(function () {
    ...
    if (!$topicId) {
        ...
        MessageUtil::setMessage("⚠️ " . TranslationService::trans('planner_hub.topic_not_found'));
...
$router->post(function () {
    ...
    if (!$topicId || !$categoryId || empty($title) || empty($content)) {
        TranslationService::detectLocale();
        MessageUtil::setMessage("⚠️ " . TranslationService::trans('planner_hub.please_fill_all_fields'));
    ...
    TranslationService::detectLocale();
    MessageUtil::setMessage("✅ " . TranslationService::trans('planner_hub.topic_updated_successfully'));
