...
$router->post(function () {
    ...
    if (!$categoryId || empty($title) || empty($content)) {
        \App\Services\TranslationService::detectLocale();
        MessageUtil::setMessage("⚠️ " . \App\Services\TranslationService::trans('planner_hub.please_fill_all_fields'));
    ...
    if (!$success) {
        \App\Services\TranslationService::detectLocale();
        MessageUtil::setMessage("⚠️ " . \App\Services\TranslationService::trans('planner_hub.error_creating_topic'));
        LocationUtils::redirectInternal("panel/forum/create");
        return;
    }
    ...
    \App\Services\TranslationService::detectLocale();
    MessageUtil::setMessage("✅ " . \App\Services\TranslationService::trans('planner_hub.topic_created_successfully'));
