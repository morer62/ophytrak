...
$router->get(function () {
    ...
    if (is_null($cards)) {
        ...
        MessageUtil::setMessage(TranslationService::trans('planner_hub.must_add_payment_method_before_service'));
...
$router->post(function () {
    ...
    if (PlatformDetector::isMobileApp()) {
        ...
        return JsonResponse::createResponse([
            "success" => false,
            "message" => TranslationService::trans('planner_hub.service_creation_not_available_mobile')
        ], 403);
    }
