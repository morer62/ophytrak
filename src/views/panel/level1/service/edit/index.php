...
$router->get(function () {
    ...
    $id = $_GET['id'] ?? null;
    if (!$id) {
        MessageUtil::setMessage(TranslationService::trans('planner_hub.service_id_not_provided'));
...
$router->post(function () {
    ...
    try {
        ...
        MessageUtil::setMessage(str_replace('{error}', $e->getMessage(), TranslationService::trans('planner_hub.error_updating_categories')));
