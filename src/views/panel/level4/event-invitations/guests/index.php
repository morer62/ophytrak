...
$router->get(function () {
    ...
    if (!$event) {
        ...
        MessageUtil::setMessage(TranslationService::trans('planner_hub.ei_event_not_found'));
...
$router->post(function () {
    ...
    if ($action === "add_guest") {
        try {
            ...
            TranslationService::detectLocale();
            MessageUtil::setMessage(TranslationService::trans('planner_hub.ei_guest_added'));
        } catch (Exception $e) {
            TranslationService::detectLocale();
            MessageUtil::setMessage(TranslationService::trans('planner_hub.ei_error_adding_guest') . " " . $e->getMessage());
        }
