...
$router->post(function () {
    ...
    if ($action === "update_design") {
        ...
        TranslationService::detectLocale();
        MessageUtil::setMessage(TranslationService::trans('planner_hub.ei_design_updated'));
        LocationUtils::redirectInternal("panel/event-invitations/manage?id=" . $eventId);
    }
    ...
    if ($action === "change_status") {
        ...
        TranslationService::detectLocale();
        MessageUtil::setMessage(TranslationService::trans('planner_hub.ei_status_updated') . " " . $status);
        LocationUtils::redirectInternal("panel/event-invitations/manage?id=" . $eventId);
    }
});
