...
$router->post(function () {
    ...
    if ($action === "addManualHour") {
        ...
        if (!$userId || !$startInput || !$endInput) {
            \App\Utils\MessageUtil::setMessage(TranslationService::trans('planner_hub.provide_start_end_user'));
        ...
        if (strtotime($endTime) <= strtotime($startTime)) {
            \App\Utils\MessageUtil::setMessage(TranslationService::trans('planner_hub.end_time_must_later'));
            \App\Utils\LocationUtils::reload();
        }
        ...
        if ($created) {
            \App\Utils\MessageUtil::setMessage(TranslationService::trans('planner_hub.manual_hours_added'));
        } else {
            \App\Utils\MessageUtil::setMessage(TranslationService::trans('planner_hub.unable_add_manual_hours'), "Error", "error");
        }
