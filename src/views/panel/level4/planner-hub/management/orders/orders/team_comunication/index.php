...
$router->post(function () {
    ...
    if (!$order) {
        MessageUtil::setMessage('❌ ' . TranslationService::trans('planner_hub.order_not_found'));
        LocationUtils::redirectInternal(orders_list_path());
    }
    ...
    switch ($action) {
        case 'update-team-needed':
            ...
            if ($total < 1) {
                MessageUtil::setMessage('⚠️ ' . TranslationService::trans('planner_hub.invalid_team_size'));
            ...
            MessageUtil::setMessage('✅ ' . TranslationService::trans('planner_hub.team_size_updated'));
            LocationUtils::reload();
