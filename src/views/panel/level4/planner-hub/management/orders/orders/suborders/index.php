...
$router->get(callback: function () {
    ...
    // Nivel 1, 2 y 3: órdenes/subórdenes y pagos de este usuario. Nivel 4: getOwner() (institución).
    ...
    if ($user->getLevel() === 4) {
        ...
        if ($order && $order->id_owner != $ownerId) {
            $order = null;
        }
    }
    ...
    if ($user->getLevel() === 4) {
        ...
        $clients = $userRepo->getAllAssociatedClients($ownerId);
    }
