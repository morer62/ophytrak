...
$router->post(function (Request $request) {
    ...
    return appleAppSignupResponse($user, $businessOwnerId, false, $token);
});
...
function appleAppSignupResponse(object $user, int $businessOwnerId, bool $associatedExisting = false, ?string $token = null): JsonResponse
{
    if ($token === null) {
        $token = bin2hex(random_bytes(32));
