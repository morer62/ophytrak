...
$router->post(function (Request $request) {
    ...
    return googleAppSignupResponse($user, $businessOwnerId, false, $token);
});
...
function googleAppSignupResponse(object $user, int $businessOwnerId, bool $associatedExisting = false, ?string $token = null): JsonResponse
{
    if ($token === null) {
        $token = bin2hex(random_bytes(32));
