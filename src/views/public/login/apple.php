...
const APPLE_WEB_LOGIN_ENABLED = false;

if (!APPLE_WEB_LOGIN_ENABLED) {
    MessageUtil::setMessage("Apple login is currently disabled. Please sign in with email and password.");
